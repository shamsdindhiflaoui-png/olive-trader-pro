...
interface StatusBadgeProps {
  status: 'open' | 'closed' | 'paid' | 'unpaid' | 'disponible' | 'plein' | 'indisponible' | 'br' | 'direct';
  label?: string;
  className?: string;
}
...
const statusConfig = {
  ...
  br: { label: 'BR', className: 'bg-emerald-100 text-emerald-800' },
  direct: { label: 'Direct', className: 'bg-amber-100 text-amber-800' },
};
